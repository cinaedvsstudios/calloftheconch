...
@export_range(20.0, 500.0, 5.0) var minimum_emergence_distance: float = 185.0
...
func get_emergence_target_global_position(emergence_seconds: float) -> Vector2:
	var launch_distance: float = maxf(
		minimum_emergence_distance,
		transport_launch_speed * maxf(0.0, emergence_seconds),
	)
	return get_exit_global_position() + get_launch_direction() * launch_distance
...
func get_debug_lines() -> Array[String]:
	...
	return [
		...
		"vacuum_output_minimum_distance=%.1f" % minimum_emergence_distance,
